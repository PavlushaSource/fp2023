...
type arg = types * string [@@deriving show { with_path = false }]
...
type statements =
  ...
  | For of statements option * expr option * expr option (** init?; cond?; upd? *)
...
and prog =
  ...
  | Func_def of prog * statements list
